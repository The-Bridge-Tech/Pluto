...
class LineMsg(metaclass=Metaclass_LineMsg):
    ...
    _fields_and_field_types = {
        'point1': 'geometry_msgs/Point',
        'point2': 'geometry_msgs/Point',
        'angle': 'double',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Point
        self.point1 = kwargs.get('point1', Point())
        from geometry_msgs.msg import Point
        self.point2 = kwargs.get('point2', Point())
    ...
    def point1(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'point1' field must be a sub message of type 'Point'"
        self._point1 = value

    @builtins.property
    def point2(self):
        """Message field 'point2'."""
        return self._point2
    ...
    def point2(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, Point), \
                "The 'point2' field must be a sub message of type 'Point'"
        self._point2 = value
