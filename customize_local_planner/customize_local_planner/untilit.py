...
def process_from_global_path(global_path: Pose, forward_prediction_step: int):
    ...
    future_way_point: Pose = None
    current_way_point: Pose = global_path.poses[0]
    ...
    new_heading_angle = calculate_heading_angle_between_two_position(current_way_point.position.x, current_way_point.position.y,
                                                                     future_way_point.position.x, future_way_point.position.y)
