...
def generate_launch_description():
    ...
    auto_start = LaunchConfiguration("autostart", default="false")  #TODO: change later
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([fishbot_navigation2_dir,'/launch','/bringup_launch.py']),
            launch_arguments={
                'map': map_yaml_path,
                'use_sim_time': use_sim_time,
                'params_file': nav2_param_path,
                'autostart':auto_start}.items(),
        ),
        # Node(
        #     package='rviz2',
        #     executable='rviz2',
